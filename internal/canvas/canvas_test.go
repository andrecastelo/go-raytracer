...
func (suite *CanvasSuite) TestCanvasCreation() {
	...
	suite.Equal(firstPixel.Array(), [...]float64{0.0, 0.0, 0.0, 0.0})

	lastPixel := canvas.Pixels[15][31]
	suite.Equal(lastPixel.Array(), [...]float64{0.0, 0.0, 0.0, 0.0})
}
...
func (suite *CanvasSuite) TestWritingPixelToCanvas() {
	...
	suite.Equal(canvas.Pixels[3][2].Array(), [...]float64{1.0, 0.0, 0.0, 0.0})
}
